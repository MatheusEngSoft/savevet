...
function PerfilVetAdmin() {
  return (
    <div className="bg-white flex flex-col w-[640px] mx-auto">
      ...
      <div className="flex justify-center items-center h-screen w-[450px] mx-auto">
        <div className="relative w-[768px] h-[544px] shadow-md rounded-xl overflow-hidden">
          <div className="absolute top-32 left-32 rounded-full z-10">
      ...
      <div className='flex justify-center items-center'>
        <div className='relative w-[450px] h-96 shadow-md rounded-xl overflow-auto bg-white p-4 m-0'>
      ...
      <div className="flex justify-center items-center mt-5">
        <div className='relative w-[450px] h-96 shadow-md rounded-xl overflow-auto bg-white p-4'>
